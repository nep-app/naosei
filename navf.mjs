...
await p.screenshot({path:SS+'f1_list.png',fullPage:true});
// open own pinned post to see edit + pin
await p.getByText('A minha primeira publicação').click();await p.waitForTimeout(700);
await p.screenshot({path:SS+'f1_own.png',fullPage:true});
